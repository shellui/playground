...
const variantStyles = {
  default: 'border border-border/80 bg-muted/50 text-foreground [&>svg]:text-foreground',
  destructive:
...
const AlertDescription = forwardRef(({ className = '', ...props }, ref) => (
  <div
    ref={ref}
    className={[
      'mt-1.5 text-sm leading-relaxed text-muted-foreground [&_p]:leading-relaxed',
      className,
    ]
      .filter(Boolean)
      .join(' ')}
